            ...
            <table class="table table-bordered">
                ...
                <%
                    ...
                    for (Funcionario func : funcionarios) {
                        ...
                        out.print("<td id='cmd'><a href='../../../alterarFunc.jsp?MatriculaFunc=" + func.getMatriculaFunc() + "'><img src='../../../img/alterar.png' title='Alterar' /></a></td>");
                        out.print("<td id='cmd'><a href='FuncionarioExcluir.jsp?MatriculaFunc=" + func.getMatriculaFunc() + "'><img src='../../../img/excluir.png' title='Excluir' /></a></td>");
